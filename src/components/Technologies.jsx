...
import { RiJavaFill, RiJavaLine, RiJavascriptLine, RiReactjsLine } from 'react-icons/ri'
    ...
    return (
        <div className='border-b border-neutral-800 pb-24'>
            ...
            className="flex flex-wrap items-center justify-center gap-4">
                ...
                <motion.div variants={iconVariants(2.1)}
                    initial="initial"
                    animate="animate"
                    className='rounded-2xl border-4 border-neutral-800 p-4'>
                ...
                <motion.div variants={iconVariants(1.9)}
                    initial="initial"
                    animate="animate"
                    className='rounded-2xl border-4 border-neutral-800 p-4'>
